...
import { XIcon, AirplayIcon, SettingsIcon } from "lucide-animated";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="popup-drag-head drag-area"
            ...
            {showWelcomeSplash ? (
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="TabsTriggerIcon">
                      <AnimatedIcon animation="none" isActive={tab === "dashboard"}><SettingsIcon style={{ display: "flex", alignItems: "center", justifyContent: "center" }} size={16} color="currentColor" strokeWidth={2.5} /></AnimatedIcon>
                    </div>
