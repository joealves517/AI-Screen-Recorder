...
const Backup = () => {
  ...
  const initLocalDirectory = async (directoryHandle, prompt = true) => {
    ...
    if (permissions) {
      let videoTitle = `AI Screen Recorder video - ${new Date().toLocaleString("en-US", {
        month: "short",
        day: "numeric",
        year: "numeric",
        hour: "numeric",
      ...
      alert(
        "Failed to set up local backup. Reach out to us at support@aiscreenrecorder.app for more help. You can still record your screen.",
      );
  ...
  const localSaving = async (prompt = true) => {
    ...
    if ("showDirectoryPicker" in window) {
      ...
      alert(
        "Your browser doesn't support local backups. Reach out to us at support@aiscreenrecorder.app for more help. You can still record your screen.",
      );
      chrome.storage.local.set({ backup: false });
      chrome.runtime.sendMessage({
        type: "backup-created",
