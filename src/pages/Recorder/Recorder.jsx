...
const Recorder = () => {
  ...
  function armStartGateTimeout() {
    ...
    startGateTimeout.current = setTimeout(() => {
      ...
      console.warn("[AISR:startRec] stream never became ready", diagInfo);
  ...
  async function startRecording() {
    ...
    if (!helperVideoStream.current) {
      ...
      console.warn("[AISR:startRec] helperVideoStream is null", diagInfo);
    ...
    if (videoTracks.length === 0) {
      ...
      console.warn("[AISR:startRec] helperVideoStream has 0 video tracks", diagInfo);
    ...
    }
    {
      ...
      if (vt.readyState === "ended") {
        console.warn("[AISR:startRec] video track present but ended", diagInfo);
